Refinery::Images.configure do |config|
  ...
  # Configure image sizes
   config.user_image_sizes = {:small=>"110x110>",  :news => "140x140" , :medium=>"225x255>", :large=>"450x450>", :extra_large=>"550x550"}
  ...
  # config.datastore_root_path = "/home/matin/RailsProjects/msdc/public/system/refinery/images"
